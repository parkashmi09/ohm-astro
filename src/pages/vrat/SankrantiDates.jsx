    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-6 mb-12">
          <p>
            Pradosh Vrat also known as Pradosham is one of the most celebrated
            Hindu Vrats. It is observed to obtain Lord Shiva and Goddess
            Parvati's blessings.
          </p>
          <p>
            People keep this vrat for happiness, spirituality, and health. The
            timings of Pradosh Kaal usually fall in 'Sandhyakal,' or at the time
            of twilight.
          </p>
        </div>
